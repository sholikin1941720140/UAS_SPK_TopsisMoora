...
@section('container')
    <div class="page-heading">
        ...
        <section class="section">
            <div class="col-12 col-md-6 order-md-1 order-last mb-2">
                <h5>Matriks Ternomalisasi Terbobot</h5>
            </div>
            <div class="card">
                <div class="card-body">
                    <table class="table table-striped" id="table1">
        ...
        <section class="section">
            ...
            <div class="card">
                <div class="card-body">
                    <h5>Kesimpulan:</h5>
                    <p>Dengan menggunakan metode TOPSIS yang memiliki <b>{{ count($alternatifs) }} alternatif </b> dan <b>{{ count($kriterias) }} kriteria</b></p>
                    <p>Alternatif terbaik adalah <b>{{ $rank[6]->alternatif_code }}</b> dengan nilai <b>{{ round($rank[6]->preferenceValue, 3) }}</b></p>
                </div>
            </div>
        </section>
    </div>
